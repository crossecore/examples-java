...
import {ASTNodeImpl} from "./ASTNodeImpl";
			...
			export class AbstractMethodInvocationBase
			extends ASTNodeImpl
			implements AbstractMethodInvocation
			{
				...
				protected eStaticClass():EClass{
					...
					return AbstractMethodInvocationBase.eStaticClass;
				}
			
				public eInverseAdd(otherEnd:InternalEObject, featureID:number, msgs:NotificationChain): NotificationChain{
					switch (featureID) {
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_METHOD:
							if (this._method != null){
				...
				//public eInverseAddFromAbstractMethodInvocation = this.eInverseAdd;
				...
				//public eInverseRemoveFromAbstractMethodInvocation = this.eInverseRemove;
				...
				public eGet_number_boolean_boolean(featureID:number, resolve:boolean, coreType:boolean):any{
					switch (featureID) {
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_COMMENTS:
							return this.comments;
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_ORIGINALCOMPILATIONUNIT:
							return this.originalCompilationUnit;
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_ORIGINALCLASSFILE:
							return this.originalClassFile;
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_METHOD:
							return this.method;
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_ARGUMENTS:
							return this.arguments_;
						case Java_PackageLiterals.ABSTRACTMETHODINVOCATION_TYPEARGUMENTS:
