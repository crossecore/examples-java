...
import {StatementImpl} from "java_/StatementImpl";
			...
			implements LabeledStatement
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.LABELEDSTATEMENT;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						...
						case Java_PackageLiterals.LABELEDSTATEMENT_USAGESINBREAKSTATEMENTS:
							...
							this.usagesInBreakStatements.concat((newValue as AbstractCollection<EObject>).map(i => i as BreakStatement));
							return;
						case Java_PackageLiterals.LABELEDSTATEMENT_USAGESINCONTINUESTATEMENTS:
							this.usagesInContinueStatements.clear();
							this.usagesInContinueStatements.concat((newValue as AbstractCollection<EObject>).map(i => i as ContinueStatement));
							return;
					}
				...
				public eBaseStructuralFeatureID(derivedFeatureID:number, baseClass:Function):number {
					if (baseClass instanceof StatementImpl) {
