...
import {Package} from "java_/Package";
			...
			implements CompilationUnit
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.COMPILATIONUNIT;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						...
						case Java_PackageLiterals.COMPILATIONUNIT_COMMENTLIST:
							...
							this.commentList.concat((newValue as AbstractCollection<EObject>).map(i => i as Comment));
							return;
						case Java_PackageLiterals.COMPILATIONUNIT_IMPORTS:
							this.imports.clear();
							this.imports.concat((newValue as AbstractCollection<EObject>).map(i => i as ImportDeclaration));
							return;
						case Java_PackageLiterals.COMPILATIONUNIT_PACKAGE:
						...
						case Java_PackageLiterals.COMPILATIONUNIT_TYPES:
							this.types.clear();
							this.types.concat((newValue as AbstractCollection<EObject>).map(i => i as AbstractTypeDeclaration));
							return;
					}
