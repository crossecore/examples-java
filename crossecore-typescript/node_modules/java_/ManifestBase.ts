...
import {NotificationChain} from "ecore/NotificationChain";
			...
			implements Manifest
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.MANIFEST;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						case Java_PackageLiterals.MANIFEST_MAINATTRIBUTES:
							...
							this.mainAttributes.concat((newValue as AbstractCollection<EObject>).map(i => i as ManifestAttribute));
							return;
						case Java_PackageLiterals.MANIFEST_ENTRYATTRIBUTES:
							this.entryAttributes.clear();
							this.entryAttributes.concat((newValue as AbstractCollection<EObject>).map(i => i as ManifestEntry));
							return;
					}
