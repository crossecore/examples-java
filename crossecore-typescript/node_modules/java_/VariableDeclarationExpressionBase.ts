...
import {AbstractVariablesContainerImpl} from "java_/AbstractVariablesContainerImpl";
			...
			implements VariableDeclarationExpression
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.VARIABLEDECLARATIONEXPRESSION;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						...
						case Java_PackageLiterals.VARIABLEDECLARATIONEXPRESSION_FRAGMENTS:
							...
							this.fragments.concat((newValue as AbstractCollection<EObject>).map(i => i as VariableDeclarationFragment));
							return;
						case Java_PackageLiterals.VARIABLEDECLARATIONEXPRESSION_MODIFIER:
						...
						case Java_PackageLiterals.VARIABLEDECLARATIONEXPRESSION_ANNOTATIONS:
							...
							this.annotations.concat((newValue as AbstractCollection<EObject>).map(i => i as Annotation));
							return;
					}
				...
				public eBaseStructuralFeatureID(derivedFeatureID:number, baseClass:Function):number {
					if (baseClass instanceof AbstractVariablesContainerImpl) {
