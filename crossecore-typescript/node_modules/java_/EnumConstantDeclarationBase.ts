			...
			implements EnumConstantDeclaration
			{
				...
				get arguments():OrderedSet<Expression>{
					if(this._arguments===null){
						this._arguments = new OrderedSet<Expression>(this, Java_PackageLiterals.ENUMCONSTANTDECLARATION_ARGUMENTS, BasicEObjectImpl.EOPPOSITE_FEATURE_BASE - Java_PackageLiterals.ENUMCONSTANTDECLARATION_ARGUMENTS);
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.ENUMCONSTANTDECLARATION;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						...
						case Java_PackageLiterals.ENUMCONSTANTDECLARATION_USAGEINVARIABLEACCESS:
							...
							this.usageInVariableAccess.concat((newValue as AbstractCollection<EObject>).map(i => i as SingleVariableAccess));
							return;
						case Java_PackageLiterals.ENUMCONSTANTDECLARATION_ANONYMOUSCLASSDECLARATION:
				...
				public eBaseStructuralFeatureID(derivedFeatureID:number, baseClass:Function):number {
					if (baseClass instanceof VariableDeclarationImpl) {
