...
import {Archive} from "java_/Archive";
			...
			implements Model
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.MODEL;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						...
						case Java_PackageLiterals.MODEL_OWNEDELEMENTS:
							...
							this.ownedElements.concat((newValue as AbstractCollection<EObject>).map(i => i as Package));
							return;
						case Java_PackageLiterals.MODEL_ORPHANTYPES:
							this.orphanTypes.clear();
							this.orphanTypes.concat((newValue as AbstractCollection<EObject>).map(i => i as Type));
							return;
						case Java_PackageLiterals.MODEL_UNRESOLVEDITEMS:
							this.unresolvedItems.clear();
							this.unresolvedItems.concat((newValue as AbstractCollection<EObject>).map(i => i as UnresolvedItem));
							return;
						case Java_PackageLiterals.MODEL_COMPILATIONUNITS:
							this.compilationUnits.clear();
							this.compilationUnits.concat((newValue as AbstractCollection<EObject>).map(i => i as CompilationUnit));
							return;
						case Java_PackageLiterals.MODEL_CLASSFILES:
							this.classFiles.clear();
							this.classFiles.concat((newValue as AbstractCollection<EObject>).map(i => i as ClassFile));
							return;
						case Java_PackageLiterals.MODEL_ARCHIVES:
							this.archives.clear();
							this.archives.concat((newValue as AbstractCollection<EObject>).map(i => i as Archive));
							return;
					}
