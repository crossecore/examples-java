...
import {NotificationChain} from "ecore/NotificationChain";
			...
			implements AbstractMethodDeclaration
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.ABSTRACTMETHODDECLARATION;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						...
						case Java_PackageLiterals.ABSTRACTMETHODDECLARATION_PARAMETERS:
							...
							this.parameters.concat((newValue as AbstractCollection<EObject>).map(i => i as SingleVariableDeclaration));
							return;
						case Java_PackageLiterals.ABSTRACTMETHODDECLARATION_THROWNEXCEPTIONS:
							this.thrownExceptions.clear();
							this.thrownExceptions.concat((newValue as AbstractCollection<EObject>).map(i => i as TypeAccess));
							return;
						case Java_PackageLiterals.ABSTRACTMETHODDECLARATION_TYPEPARAMETERS:
							this.typeParameters.clear();
							this.typeParameters.concat((newValue as AbstractCollection<EObject>).map(i => i as TypeParameter));
							return;
						case Java_PackageLiterals.ABSTRACTMETHODDECLARATION_USAGESINDOCCOMMENTS:
							this.usagesInDocComments.clear();
							this.usagesInDocComments.concat((newValue as AbstractCollection<EObject>).map(i => i as MethodRef));
							return;
						case Java_PackageLiterals.ABSTRACTMETHODDECLARATION_USAGES:
							this.usages.clear();
							this.usages.concat((newValue as AbstractCollection<EObject>).map(i => i as AbstractMethodInvocation));
							return;
					}
