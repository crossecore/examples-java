...
import {Package} from "java_/Package";
			...
			implements Package
			{
				...
				protected eStaticClass():EClass{
					//return Java_PackageLiterals.PACKAGE;
					return null;
				}
				*/
				...
				public eSet_number_any(featureID:number, newValue:any):void {
					switch (featureID) {
						case Java_PackageLiterals.PACKAGE_OWNEDELEMENTS:
							...
							this.ownedElements.concat((newValue as AbstractCollection<EObject>).map(i => i as AbstractTypeDeclaration));
							return;
						case Java_PackageLiterals.PACKAGE_MODEL:
						...
						case Java_PackageLiterals.PACKAGE_OWNEDPACKAGES:
							...
							this.ownedPackages.concat(newValue);
							return;
						case Java_PackageLiterals.PACKAGE_PACKAGE:
						...
						case Java_PackageLiterals.PACKAGE_USAGESINPACKAGEACCESS:
							...
							this.usagesInPackageAccess.concat((newValue as AbstractCollection<EObject>).map(i => i as PackageAccess));
							return;
					}
