 ...
 extends ASTNode
{
	...
	public static com.crossecore.ocl.QuickSet<NamedElement> allInstances_ = new com.crossecore.ocl.QuickSet<NamedElement>(NamedElement.class);
	
		
	public static com.crossecore.ocl.QuickSet<NamedElement> allInstances(){
		
		com.crossecore.ocl.QuickSet<NamedElement> result = new com.crossecore.ocl.QuickSet<NamedElement>(NamedElement.class);
	...
	//public static com.crossecore.ocl.QuickSet<NamedElement> allInstances = new com.crossecore.ocl.QuickSet<NamedElement>(NamedElement.class);
	...
	com.crossecore.ocl.Set<ImportDeclaration> getUsagesInImports();
