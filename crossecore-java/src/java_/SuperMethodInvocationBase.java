...
extends AbstractTypeQualifiedExpressionImpl implements SuperMethodInvocation
{
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_PackageImpl.SUPER_METHOD_INVOCATION__METHOD:
				if (_method != null){
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_PackageImpl.SUPER_METHOD_INVOCATION__METHOD:
				return getMethod();
			case Java_PackageImpl.SUPER_METHOD_INVOCATION__ARGUMENTS:
				return getArguments();
			case Java_PackageImpl.SUPER_METHOD_INVOCATION__TYPE_ARGUMENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractMethodInvocation.class) {
			switch (derivedFeatureID) {
				case Java_PackageImpl.SUPER_METHOD_INVOCATION__METHOD: return Java_PackageImpl.ABSTRACT_METHOD_INVOCATION__METHOD;
				case Java_PackageImpl.SUPER_METHOD_INVOCATION__ARGUMENTS: return Java_PackageImpl.ABSTRACT_METHOD_INVOCATION__ARGUMENTS;
				case Java_PackageImpl.SUPER_METHOD_INVOCATION__TYPE_ARGUMENTS: return Java_PackageImpl.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractMethodInvocation.class) {
			switch (baseFeatureID) {
				case Java_PackageImpl.ABSTRACT_METHOD_INVOCATION__METHOD: return Java_PackageImpl.SUPER_METHOD_INVOCATION__METHOD;
				case Java_PackageImpl.ABSTRACT_METHOD_INVOCATION__ARGUMENTS: return Java_PackageImpl.SUPER_METHOD_INVOCATION__ARGUMENTS;
				case Java_PackageImpl.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS: return Java_PackageImpl.SUPER_METHOD_INVOCATION__TYPE_ARGUMENTS;
				default: return -1;
			}
		}
