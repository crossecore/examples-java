...
extends ExpressionImpl implements StringLiteral
{
	...
	public void setEscapedValue(java.lang.String value){
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java_PackageImpl.STRING_LITERAL__ESCAPED_VALUE, oldValue, value));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_PackageImpl.STRING_LITERAL__ESCAPED_VALUE:
