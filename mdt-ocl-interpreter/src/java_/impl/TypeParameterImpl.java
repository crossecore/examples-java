 ...
 * </p>
 * <ul>
 *   <li>{@link java_.impl.TypeParameterImpl#getBounds <em>Bounds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeParameterImpl extends TypeImpl implements TypeParameter {
	...
	protected EClass eStaticClass() {
		return Java_Package.eINSTANCE.getTypeParameter();
	}
	...
	public EList<TypeAccess> getBounds() {
		if (bounds == null) {
			bounds = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this, Java_Package.TYPE_PARAMETER__BOUNDS);
		}
		return bounds;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_Package.TYPE_PARAMETER__BOUNDS:
