 ...
 * </p>
 * <ul>
 *   <li>{@link java_.impl.JavadocImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavadocImpl extends CommentImpl implements Javadoc {
	...
	protected EClass eStaticClass() {
		return Java_Package.eINSTANCE.getJavadoc();
	}
	...
	public EList<TagElement> getTags() {
		if (tags == null) {
			tags = new EObjectContainmentEList<TagElement>(TagElement.class, this, Java_Package.JAVADOC__TAGS);
		}
		return tags;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_Package.JAVADOC__TAGS:
