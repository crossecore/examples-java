 ...
 * </p>
 * <ul>
 *   <li>{@link java_.impl.WildCardTypeImpl#isUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link java_.impl.WildCardTypeImpl#getBound <em>Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WildCardTypeImpl extends TypeImpl implements WildCardType {
	...
	protected EClass eStaticClass() {
		return Java_Package.eINSTANCE.getWildCardType();
	}
	...
	public void setUpperBound(boolean newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java_Package.WILD_CARD_TYPE__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public NotificationChain basicSetBound(TypeAccess newBound, NotificationChain msgs) {
		...
		bound = newBound;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Java_Package.WILD_CARD_TYPE__BOUND, oldBound, newBound);
	...
	public void setBound(TypeAccess newBound) {
		if (newBound != bound) {
			...
			if (bound != null)
				msgs = ((InternalEObject)bound).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Java_Package.WILD_CARD_TYPE__BOUND, null, msgs);
			if (newBound != null)
				msgs = ((InternalEObject)newBound).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Java_Package.WILD_CARD_TYPE__BOUND, null, msgs);
			msgs = basicSetBound(newBound, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java_Package.WILD_CARD_TYPE__BOUND, newBound, newBound));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_Package.WILD_CARD_TYPE__BOUND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_Package.WILD_CARD_TYPE__UPPER_BOUND:
				return isUpperBound();
			case Java_Package.WILD_CARD_TYPE__BOUND:
				return getBound();
		}
