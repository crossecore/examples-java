...
public final class CommentTextQuerySpecification extends BaseGeneratedEMFQuerySpecification<CommentTextMatcher> {
   ...
   * 
   */
  public static CommentTextQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected CommentTextMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return CommentTextMatcher.on(engine);
  }
  
  @Override
  public CommentTextMatcher instantiate() throws ViatraQueryException {
    return CommentTextMatcher.create();
  }
  ...
  public CommentTextMatch newMatch(final Object... parameters) {
    return CommentTextMatch.newMatch((java_.TextElement) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CommentTextQuerySpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CommentTextQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static CommentTextQuerySpecification INSTANCE = new CommentTextQuerySpecification();
