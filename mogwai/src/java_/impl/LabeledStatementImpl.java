 ...
 * </p>
 * <ul>
 *   <li>{@link java_.impl.LabeledStatementImpl#getBody <em>Body</em>}</li>
 *   <li>{@link java_.impl.LabeledStatementImpl#getUsagesInBreakStatements <em>Usages In Break Statements</em>}</li>
 *   <li>{@link java_.impl.LabeledStatementImpl#getUsagesInContinueStatements <em>Usages In Continue Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabeledStatementImpl extends NamedElementImpl implements LabeledStatement {
	...
	protected EClass eStaticClass() {
		return Java_Package.eINSTANCE.getLabeledStatement();
	}
	...
	public NotificationChain basicSetBody(Statement newBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Java_Package.LABELED_STATEMENT__BODY, oldBody, newBody);
	...
	public void setBody(Statement newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Java_Package.LABELED_STATEMENT__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Java_Package.LABELED_STATEMENT__BODY, null, msgs);
			msgs = basicSetBody(newBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java_Package.LABELED_STATEMENT__BODY, newBody, newBody));
	}
	...
	public EList<BreakStatement> getUsagesInBreakStatements() {
		if (usagesInBreakStatements == null) {
			usagesInBreakStatements = new EObjectWithInverseResolvingEList<BreakStatement>(BreakStatement.class, this, Java_Package.LABELED_STATEMENT__USAGES_IN_BREAK_STATEMENTS, Java_Package.BREAK_STATEMENT__LABEL);
		}
	...
	public EList<ContinueStatement> getUsagesInContinueStatements() {
		if (usagesInContinueStatements == null) {
			usagesInContinueStatements = new EObjectWithInverseResolvingEList<ContinueStatement>(ContinueStatement.class, this, Java_Package.LABELED_STATEMENT__USAGES_IN_CONTINUE_STATEMENTS, Java_Package.CONTINUE_STATEMENT__LABEL);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_Package.LABELED_STATEMENT__USAGES_IN_BREAK_STATEMENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getUsagesInBreakStatements()).basicAdd(otherEnd, msgs);
			case Java_Package.LABELED_STATEMENT__USAGES_IN_CONTINUE_STATEMENTS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_Package.LABELED_STATEMENT__BODY:
