 ...
 * </p>
 * <ul>
 *   <li>{@link java_.impl.AbstractMethodInvocationImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link java_.impl.AbstractMethodInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link java_.impl.AbstractMethodInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractMethodInvocationImpl extends ASTNodeImpl implements AbstractMethodInvocation {
	...
	protected EClass eStaticClass() {
		return Java_Package.eINSTANCE.getAbstractMethodInvocation();
	}
		...
		if (method != null && method.eIsProxy()) {
			...
			if (method != oldMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Java_Package.ABSTRACT_METHOD_INVOCATION__METHOD, oldMethod, method));
			}
		}
		return method;
	}
	...
	public NotificationChain basicSetMethod(AbstractMethodDeclaration newMethod, NotificationChain msgs) {
		...
		method = newMethod;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Java_Package.ABSTRACT_METHOD_INVOCATION__METHOD, oldMethod, newMethod);
	...
	public void setMethod(AbstractMethodDeclaration newMethod) {
		if (newMethod != method) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Java_Package.ABSTRACT_METHOD_INVOCATION__METHOD, newMethod, newMethod));
	}
	...
	public EList<Expression> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Expression>(Expression.class, this, Java_Package.ABSTRACT_METHOD_INVOCATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public EList<TypeAccess> getTypeArguments() {
		if (typeArguments == null) {
			typeArguments = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this, Java_Package.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java_Package.ABSTRACT_METHOD_INVOCATION__METHOD:
				if (method != null)
					msgs = ((InternalEObject)method).eInverseRemove(this, Java_Package.ABSTRACT_METHOD_DECLARATION__USAGES, AbstractMethodDeclaration.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Java_Package.ABSTRACT_METHOD_INVOCATION__ARGUMENTS:
				return ((InternalEList<?>)getArguments()).basicRemove(otherEnd, msgs);
			case Java_Package.ABSTRACT_METHOD_INVOCATION__TYPE_ARGUMENTS:
