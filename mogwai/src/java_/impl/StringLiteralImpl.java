 ...
 * </p>
 * <ul>
 *   <li>{@link java_.impl.StringLiteralImpl#getEscapedValue <em>Escaped Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return Java_Package.eINSTANCE.getStringLiteral();
	}
	...
	public void setEscapedValue(String newEscapedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java_Package.STRING_LITERAL__ESCAPED_VALUE, oldEscapedValue, escapedValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java_Package.STRING_LITERAL__ESCAPED_VALUE:
