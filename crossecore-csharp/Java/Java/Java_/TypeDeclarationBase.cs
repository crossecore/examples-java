...
namespace Java_{
	...
	:AbstractTypeDeclarationImpl, TypeDeclaration
	{
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.TYPEDECLARATION_COMMENTS:
					return comments;
				case Java_PackageImpl.TYPEDECLARATION_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.TYPEDECLARATION_ORIGINALCLASSFILE:
					return originalClassFile;
				case Java_PackageImpl.TYPEDECLARATION_NAME:
					return name;
				case Java_PackageImpl.TYPEDECLARATION_PROXY:
					return proxy;
				case Java_PackageImpl.TYPEDECLARATION_USAGESINIMPORTS:
					return usagesInImports;
				case Java_PackageImpl.TYPEDECLARATION_ABSTRACTTYPEDECLARATION:
					return abstractTypeDeclaration;
				case Java_PackageImpl.TYPEDECLARATION_ANNOTATIONS:
					return annotations;
				case Java_PackageImpl.TYPEDECLARATION_ANONYMOUSCLASSDECLARATIONOWNER:
					return anonymousClassDeclarationOwner;
				case Java_PackageImpl.TYPEDECLARATION_MODIFIER:
					return modifier;
				case Java_PackageImpl.TYPEDECLARATION_USAGESINTYPEACCESS:
					return usagesInTypeAccess;
				case Java_PackageImpl.TYPEDECLARATION_BODYDECLARATIONS:
					return bodyDeclarations;
				case Java_PackageImpl.TYPEDECLARATION_COMMENTSBEFOREBODY:
					return commentsBeforeBody;
				case Java_PackageImpl.TYPEDECLARATION_COMMENTSAFTERBODY:
					return commentsAfterBody;
				case Java_PackageImpl.TYPEDECLARATION_PACKAGE:
					return package;
				case Java_PackageImpl.TYPEDECLARATION_SUPERINTERFACES:
