...
namespace Java_{
	...
	:StatementImpl, BreakStatement
	{
		...
		public virtual LabeledStatement label
		{
			...
			set {
				if (value != _label) {
					...
					if (_label != null){
						msgs = ((InternalEObject)_label).eInverseRemove(this, Java_PackageImpl.LABELEDSTATEMENT_USAGESINBREAKSTATEMENTS, typeof(BreakStatement), msgs);
					}
					if (value != null){
						msgs = ((InternalEObject)value).eInverseAdd(this, Java_PackageImpl.LABELEDSTATEMENT_USAGESINBREAKSTATEMENTS, typeof(BreakStatement), msgs);
					}
		...
		public override NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
			switch (featureID) {
				case Java_PackageImpl.BREAKSTATEMENT_LABEL:
					if (_label != null){
						msgs = ((InternalEObject)_label).eInverseRemove(this, Java_PackageImpl.BREAKSTATEMENT_LABEL, typeof(LabeledStatement), msgs);
					}
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.BREAKSTATEMENT_COMMENTS:
					return comments;
				case Java_PackageImpl.BREAKSTATEMENT_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.BREAKSTATEMENT_ORIGINALCLASSFILE:
