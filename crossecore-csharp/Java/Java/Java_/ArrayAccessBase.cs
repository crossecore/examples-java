...
namespace Java_{
	...
	:ExpressionImpl, ArrayAccess
	{
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.ARRAYACCESS_COMMENTS:
					return comments;
				case Java_PackageImpl.ARRAYACCESS_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.ARRAYACCESS_ORIGINALCLASSFILE:
