...
namespace Java_{
	...
	:VariableDeclarationImpl, SingleVariableDeclaration
	{
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_COMMENTS:
					return comments;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_ORIGINALCLASSFILE:
					return originalClassFile;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_NAME:
					return name;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_PROXY:
					return proxy;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_USAGESINIMPORTS:
					return usagesInImports;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_EXTRAARRAYDIMENSIONS:
					return extraArrayDimensions;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_INITIALIZER:
					return initializer;
				case Java_PackageImpl.SINGLEVARIABLEDECLARATION_USAGEINVARIABLEACCESS:
