...
using Ecore;
namespace Java_{
	public class ParenthesizedExpressionBase 
	:ExpressionImpl, ParenthesizedExpression
	{
		...
		protected override EClass eStaticClass() {
			return Java_PackageImpl.Literals.PARENTHESIZEDEXPRESSION;
		}
		...
		public NotificationChain basicSetExpression(Expression newobj, NotificationChain msgs) {
			...
			if (eNotificationRequired()) {
				var notification = new ENotificationImpl(this, NotificationImpl.SET, Java_PackageImpl.PARENTHESIZEDEXPRESSION_EXPRESSION, oldobj, newobj);
				if (msgs == null){
					msgs = notification;
				}
				else{
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.PARENTHESIZEDEXPRESSION_COMMENTS:
					return comments;
				case Java_PackageImpl.PARENTHESIZEDEXPRESSION_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.PARENTHESIZEDEXPRESSION_ORIGINALCLASSFILE:
