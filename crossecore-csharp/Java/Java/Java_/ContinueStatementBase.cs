...
namespace Java_{
	...
	:StatementImpl, ContinueStatement
	{
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.CONTINUESTATEMENT_COMMENTS:
					return comments;
				case Java_PackageImpl.CONTINUESTATEMENT_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.CONTINUESTATEMENT_ORIGINALCLASSFILE:
