...
namespace Java_{
	...
	:StatementImpl, ReturnStatement
	{
		...
		public override Object eGet(int featureID, bool resolve, bool coreType) {
			switch (featureID) {
				case Java_PackageImpl.RETURNSTATEMENT_COMMENTS:
					return comments;
				case Java_PackageImpl.RETURNSTATEMENT_ORIGINALCOMPILATIONUNIT:
					return originalCompilationUnit;
				case Java_PackageImpl.RETURNSTATEMENT_ORIGINALCLASSFILE:
