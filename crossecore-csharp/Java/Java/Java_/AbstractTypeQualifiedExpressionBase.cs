...
namespace Java_{
	...
	:ExpressionImpl, AbstractTypeQualifiedExpression
	{
		...
		public NotificationChain basicSetQualifier(TypeAccess newobj, NotificationChain msgs) {
			...
			if (eNotificationRequired()) {
				var notification = new ENotificationImpl(this, NotificationImpl.SET, Java_PackageImpl.ABSTRACTTYPEQUALIFIEDEXPRESSION_QUALIFIER, oldobj, newobj);
				if (msgs == null){
					msgs = notification;
				}
				else{
