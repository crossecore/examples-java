...
public class Java_PackageImpl extends EPackageImpl implements Java_Package {
	...
	public void initializePackageContents() {
		...
		initEClass(packageEClass, java_.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_OwnedElements(), this.getAbstractTypeDeclaration(), this.getAbstractTypeDeclaration_Package(), "ownedElements", null, 0, -1, java_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Model(), this.getModel(), this.getModel_OwnedElements(), "model", null, 0, 1, java_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_OwnedPackages(), this.getPackage(), this.getPackage_Package(), "ownedPackages", null, 0, -1, java_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Package(), this.getPackage(), this.getPackage_OwnedPackages(), "package", null, 0, 1, java_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_UsagesInPackageAccess(), this.getPackageAccess(), this.getPackageAccess_Package(), "usagesInPackageAccess", null, 0, -1, java_.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
